...
const CONFIG = {
  ...
  site: {
    ...
    description:
      "Backend Software Engineer specializing in distributed and fault-tolerant systems",
  ...
  projects: [
    {
      ...
      slug: "pxxl-app",
      title: "Pxxl App",
      subtitle: "Enterprise-grade cloud deployment platform",
      description:
      ...
      longDescription:
        "A powerful cloud deployment platform that enables developers to deploy websites, APIs, and databases instantly with zero configuration. Features include automatic scaling, continuous deployment, zero-downtime updates, global CDN, team collaboration, and support for 20+ frameworks including Next.js, React, Node.js, PHP, and Python.",
    ...
    },
    {
      ...
      subtitle: "Fault-tolerant task processing system",
      description:
        "Fault-tolerant task processing system with Redis and message queuing",
      longDescription:
        "A robust distributed task queue built for high-throughput workloads. Implements worker pools, retry mechanisms, and dead letter queues for handling failed tasks. Features include priority queuing, scheduled tasks, and real-time monitoring dashboard.",
      image: "assets/image.png",
      images: ["assets/image.png", "assets/image.png"],
    ...
    },
    {
      ...
      longDescription:
        "Custom-built API gateway handling millions of requests per day. Implements intelligent routing, circuit breakers, rate limiting, JWT authentication, and request/response transformation. Supports multiple protocols including REST, GraphQL, and gRPC.",
      image: "assets/image.png",
      images: ["assets/image.png"],
      technologies: ["Node.js", "Nginx", "Redis", "MongoDB", "Kubernetes"],
      date: "2023",
      type: "Infrastructure",
      client: "Enterprise",
      url: null,
    ...
    },
    {
      ...
      longDescription:
        "High-throughput analytics engine processing millions of events per second. Built with Apache Kafka for event streaming and ClickHouse for analytical queries. Features real-time dashboards, anomaly detection, and custom alert systems.",
      image: "assets/image.png",
      images: ["assets/image.png"],
      technologies: ["Python", "Kafka", "ClickHouse", "Docker", "Redis"],
      date: "2023",
      type: "Data Pipeline",
      client: "Startup",
      url: null,
    ...
    },
    {
      ...
      subtitle: "Raft consensus algorithm",
      description:
        "Educational implementation of Raft consensus for distributed systems",
      longDescription:
        "Implementation of the Raft consensus algorithm in Go, demonstrating leader election, log replication, and membership changes. Includes visualization tools and comprehensive test suite for various failure scenarios.",
      image: "assets/image.png",
      images: ["assets/image.png"],
